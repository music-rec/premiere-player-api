...
artist.albums.create(
    ...
    [
        ...
        {name: 'Principe de Vento', number: 7, src: '5dKObWhA6DQ'},
...
artist.albums.create(
    {
        ...
        slug: 'ritmo-perfeito',
        year: 2014,
        cover: 'https://img.discogs.com/QjLFVDR7gC8y9wj3h5ttnSWNiTg=/fit-in/300x300/filters:strip_icc():format(jpeg):mode_rgb():quality(40)/discogs-images/R-7366883-1439928440-8973.jpeg.jpg',
    ...
    [
        ...
        {name: 'Musica de Amor', number: 3, src: 'CeOqVJK4aM8'},
...
artist.albums.create(
    ...
    [
        ...
        {name: 'Deixa a Onda Te Levar', number: 13, src: 'lk2rb54nFMU'},
